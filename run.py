...
Q[4] = "python3 synthesizer.py -i0 ~/Downloads/Q4-health-facilities-gh.csv  -o benchmarks/noisy_output_tables/Q4-health-facilities-gh_nn-out.csv -l 3 -d 4 -t dsl.tyrell -m 735"
